...
(function (root, factory) {
    ...
    toArray(dom.wrapper.querySelectorAll(HORIZONTAL_SLIDES_SELECTOR)).forEach(
      function (hslide, h) {
        ...
        if (hslide.classList.contains('stack')) {
          toArray(hslide.querySelectorAll('section')).forEach(
            function (vslide, v) {
  ...
  function configure(options) {
    ...
    if (config.fragments === false) {
      toArray(dom.slides.querySelectorAll('.fragment')).forEach(
        function (element) {
  ...
  function loadSlide(slide, options) {
    ...
    toArray(slide.querySelectorAll('video, audio')).forEach(function (media) {
      ...
      toArray(media.querySelectorAll('source[data-src]')).forEach(
        function (source) {
  ...
  function formatEmbeddedContent() {
    ...
    if (isMobileDevice) {
      toArray(dom.slides.querySelectorAll('video, audio')).forEach(
        function (el) {
          el.controls = true;
        },
      );
  ...
  function startEmbeddedContent(element) {
    if (element && !isSpeakerNotes()) {
      // Restart GIFs
      toArray(element.querySelectorAll('img[src$=".gif"]')).forEach(
        function (el) {
