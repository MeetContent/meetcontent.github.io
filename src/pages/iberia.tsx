      ...
      about={
        <>
          <div>
            ...
            <img src="img/iberia-daniel.png" alt="Daniel Barrio Fierro" style="max-width: 30%; float: left; margin-right: 1em;"/>
            <p>
          ...
          <div>
            <h1>Sara Sánchez</h1>
            <img src="img/iberia-sara.png" alt="Sara Sánchez" style="max-width: 30%; float: left; margin-right: 1em;"/>
            <p>
